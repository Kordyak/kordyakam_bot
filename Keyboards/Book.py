...
def voice_menu_eng():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🇺🇸 Davis ♂️", callback_data="voice:en-US-DavisNeural")],
            [InlineKeyboardButton(text="🇺🇸 Tony ♂️", callback_data="voice:en-US-TonyNeural")],
            ...
            [InlineKeyboardButton(text="🇬🇧 Thomas ♂️", callback_data="voice:en-GB-ThomasNeural")],
